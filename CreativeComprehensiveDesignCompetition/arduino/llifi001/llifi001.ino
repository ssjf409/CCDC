...
// 합니다 
IPAddress ip(169, 254, 157, 246); 
//IPAddress ip(192, 168, 1, 69); 169.254.157.246
...
void setup() {
    ...
    threshold = threshold + 100; // ? 내가 100이나 줬다고?
...
void loop() {
  ...
  if(mode == 1) {
    ...
    if (client.connect(server, 3000)) { 
      ...
      client.println("Host: 106.10.50.11:3000"); 
